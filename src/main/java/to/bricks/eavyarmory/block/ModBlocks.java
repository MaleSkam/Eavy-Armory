package to.bricks.eavyarmory.block;
...
public class ModBlocks {
    public static final DeferredRegister<Block> BLOCKS =
            DeferredRegister.create(ForgeRegistries.BLOCKS, EavyArmory.MOD_ID);

    public static final RegistryObject<Block> CERAMITE_BLOCK = registerBlock("ceramite_block",
