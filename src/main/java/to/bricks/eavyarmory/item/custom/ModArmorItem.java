package to.bricks.eavyarmory.item.custom;
...
import to.bricks.eavyarmory.item.ModArmorMaterials;
...
public class ModArmorItem extends ArmorItem {
    private static final Map<ArmorMaterial, List<MobEffectInstance>> MATERIAL_TO_EFFECT_MAP =
            new ImmutableMap.Builder<ArmorMaterial, List<MobEffectInstance>>()
                    .put(ModArmorMaterials.POWER1, List.of(
                            new MobEffectInstance(MobEffects.DIG_SPEED, 220, 1, false, false, true),
                            new MobEffectInstance(MobEffects.DAMAGE_BOOST, 220, 0, false, false, true)
                    ))
                    .build();
